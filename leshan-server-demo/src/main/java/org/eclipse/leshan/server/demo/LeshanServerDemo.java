...
public class LeshanServerDemo {
    ...
    //-oscore yes -lh 10.0.0.1
    //Create subinterface with ifconfig eth0:1 10.0.0.1
    
    //Rikard: URI of client to connect over OSCORE
    private final static String CLIENT_URI = "coap://10.0.0.3";
    ...
    private static void addOSCOREContext(String serverURI) throws OSException {
    	...
    	OSCoreCtx ctx_B;
    	ctx_B = new OSCoreCtx(master_secret, true, alg, sid, rid, kdf, 32, master_salt, null);
    	
    	if(serverURI == null || serverURI.contains("localhost")) {
    		serverURI = "coap://127.0.0.1";
    	}
    	db.addContext(serverURI, ctx_B);
    ...
    public static void main(String[] args) throws OSException {
        ...
        if (cl.hasOption("oscore")) {
        	oscore = true;
        	addOSCOREContext(CLIENT_URI);
        	LOG.info("Server uses OSCORE.");
        }
